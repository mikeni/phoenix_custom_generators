defmodule Mix.PhoenixCustomGenerators.Schema do
  @moduledoc false
  ...
  def new(schema_name, schema_plural, cli_attrs, opts) do
    ...
    otp_app   = Mix.PhoenixCustomGenerators.otp_app()
    opts      = Keyword.merge(Application.get_env(otp_app, :generators, []), opts)
    base      = Mix.PhoenixCustomGenerators.context_base(ctx_app)
    ...
    file      = Mix.PhoenixCustomGenerators.context_lib_path(ctx_app, basename <> ".ex")
