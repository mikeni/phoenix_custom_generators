defmodule Mix.PhoenixCustomGenerators.Context do
  @moduledoc false
  ...
  def new(context_name, %Schema{} = schema, opts) do
    ctx_app   = opts[:context_app] || Mix.PhoenixCustomGenerators.context_app()
    base      = Module.concat([Mix.PhoenixCustomGenerators.context_base(ctx_app)])
    ...
    dir       = Mix.PhoenixCustomGenerators.context_lib_path(ctx_app, basedir)
    test_dir  = Mix.PhoenixCustomGenerators.context_test_path(ctx_app, basedir)
  ...
  defp web_module do
    base = Mix.PhoenixCustomGenerators.base()
